...
FrenchCardTexts[CardNames.HAREM] = "[!2]//---//{!2}";
...
FrenchCardTexts[CardNames.HAVEN] = "|+1 Carte|//|+1 Action|////Mettez de c\xF4t\xE9 une carte de votre//main face cach\xE9e (sous cette carte).//Au d\xE9but de votre prochain tour,//prenez-la en main.";
...
FrenchCardTexts[CardNames.OUTPOST] = "Si c'est la premi\xE8re fois que vous//jouez un Avant-poste ce tour-ci, et//si le tour pr\xE9c\xE9dent n'\xE9tait pas le//v\xF4tre, jouez un tour suppl\xE9mentaire//apr\xE8s celui-ci, et ne piochez que//3 cartes pour votre prochaine main.";
...
FrenchCardTexts[CardNames.MINT] = "Vous pouvez d\xE9voiler une carte//Tr\xE9sor de votre main. Recevez-en//un exemplaire.//---//Quand vous achetez cette carte,//\xE9cartez tous vos Tr\xE9sors en jeu.";
...
FrenchCardTexts[CardNames.INHERITANCE] = "Une fois dans la partie : mettez de c\xF4t\xE9 une carte Action non-Ordre//de la r\xE9serve co\xFBtant jusqu'\xE0 [4]. Placez dessus votre jeton Domaine.//(Durant vos tours, les Domaines sont des Actions Commande ayant pour//effet \xAB Jouez la carte sous votre jeton Domaine, sans la d\xE9placer \xBB.)";
...
FrenchCardTexts[CardNames.MISSION] = "Une fois par tour : si le tour pr\xE9c\xE9dent n'\xE9tait pas le v\xF4tre, jouez un//tour suppl\xE9mentaire apr\xE8s celui-ci pendant lequel vous ne pourrez//pas acheter de carte. (Vous pourrez acheter des \xE9v\xE9nements.)";
...
FrenchCardTexts[CardNames.DONATE] = "Juste avant de piocher votre main pour le prochain tour, prenez en main//votre pioche et votre d\xE9fausse, \xE9cartez autant de cartes que souhait\xE9//depuis votre main, puis m\xE9langez votre main dans votre pioche.";
...
FrenchCardTexts[CardNames.PRINCE] = "Vous pouvez mettre de c\xF4t\xE9//sur cette carte une carte Action//non-Dur\xE9e non-Commande de votre//main co\xFBtant jusqu'\xE0 [4]. Au d\xE9but//de chacun de vos tours, jouez cette//carte en la laissant de c\xF4t\xE9.";
...
FrenchCardTexts[CardNames.ISLAND_FOLK] = "À la fin de votre tour, si le tour précédent//n'était pas le vôtre, vous pouvez dépenser//|5 Faveurs| pour jouer un tour supplémentaire.";
...
FrenchCardTexts[CardNames.VOYAGE] = "|+1 Action|//Si le tour précédent n'était pas//le vôtre, jouez un tour//supplémentaire après celui-ci,//durant lequel vous ne pouvez jouer//que 3 cartes de votre main.";
...
FrenchCardTexts[CardNames.ELDER] = "|+[2]|//Vous pouvez jouer une carte Action//de votre main. Si elle offre un choix//entre plusieurs capacités (par exemple//à l'aide du mot « choisissez »), vous//pouvez en choisir une (différente)//supplémentaire.";
